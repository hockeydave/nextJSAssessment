...
const VehicleForm = ({defaults}: { defaults: any }) => {
    ...
    const handleTypeChange = (e: any) => {
         ...
         * For now it makes sense that if we change the Vehicle Type reset everything to default values
        */
        formState.nickname = "";
        formState.mileage = 0;
        formState.engineStatus = ENGINE_STATUS.WORKS;
        formState.seatStatus = SEAT_STATUS.WORKS;
        if (e.currentTarget.value === VEHICLE_TYPE.MOTORCYCLE) {
            formState.wheels = 2;
            formState.doors = 0;
        } else {
            formState.wheels = 4;
            if (e.currentTarget.value === VEHICLE_TYPE.COUPE)
                formState.doors = 2;
            else
                formState.doors = 4;
        }
    ...
    return (
        <main>
            <form method="POST" onSubmit={handleSubmit}>
                ...
                <select id="vehicleType" name="vehicleType" data-testid="vehicleType" onChange={handleTypeChange}
                ...
                <div>
                    ...
                    <input name="nickname" type="text" id="nickname" data-testid="nickname" onChange={handleChange}
                           value={formState.nickname}/>
                </div>
                <div>
                    <label htmlFor="mileage">Mileage</label>
                    <input name="mileage" type="number" id="mileage" data-testid="mileage" onChange={handleChange}
                           value={formState.mileage}/>
                </div>
                {formState.vehicleType !== VEHICLE_TYPE.MOTORCYCLE &&
                    <div>
                        <label htmlFor="wheels">Wheels</label>
                        <input name="wheels" type="number" id="wheels" data-testid="wheels" onChange={handleChange}
                ...
                {formState.vehicleType !== VEHICLE_TYPE.MOTORCYCLE &&
                    <div>
                        ...
                        <input name="doors" type="number" id="doors" data-testid="doors" onChange={handleChange}
                ...
                <div>
                    ...
                    <select id="engineStatus" name="engineStatus" data-testid="engineStatus" onChange={handleChange}
                            value={formState.engineStatus}>
                ...
                {formState.vehicleType === VEHICLE_TYPE.MOTORCYCLE &&
                    <div>
                        ...
                        <select id="seatStatus" name="seatStatus" data-testid="seatStatus" onChange={handleChange}
                                value={formState.seatStatus}>
